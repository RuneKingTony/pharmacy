  ...
  return (
    <section className="bg-gray-100 py-10" id='services'>
      <div className="container mx-auto">
        <h2 className="text-3xl font-bold text-center mb-8">What <span className='text-green'>We Do?</span></h2>
        <div className="max-w-3xl mx-auto">
          ...
          <br />
          <p className="text-lg text-gray-700 leading-relaxed p-4">
            <strong>PHC-ACCESS TO MEDICINE INITIATIVE (PHC-ATM)</strong>
            <br />
          ...
          <br />
          <p className="text-lg text-gray-700 leading-relaxed p-4">
            <strong>PHC SUPPLY CHAIN MENTORSHIP PROGRAM (PHC-SCM PROGRAM)</strong>
            <br />
          ...
          <br />
          <p className="text-lg text-gray-700 leading-relaxed p-4">
            <strong>PHARMA-AID NCD PHARMA BANK</strong>
            <br />
          ...
          <br />
          <p className="text-lg text-gray-700 leading-relaxed p-4">
            <strong>AfCFTA Pharma Market Access Program</strong>
            <br />
